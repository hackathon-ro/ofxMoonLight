...
static int ofURLFileLoader_get(lua_State *L) {
  try {
    ...
    string *url = *((string **)dub_checksdata(L, 2, "string"));
    dub_pushudata(L, new ofHttpResponse(self->get(*url)), "ofHttpResponse", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofURLFileLoader_getAsync(lua_State *L) {
  try {
    ...
    if (top__ >= 3) {
      string *url = *((string **)dub_checksdata(L, 2, "string"));
      string *name = *((string **)dub_checksdata(L, 3, "string"));
      lua_pushnumber(L, self->getAsync(*url, *name));
      return 1;
    } else {
      string *url = *((string **)dub_checksdata(L, 2, "string"));
      lua_pushnumber(L, self->getAsync(*url));
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofURLFileLoader_saveTo(lua_State *L) {
  try {
    ofURLFileLoader *self = *((ofURLFileLoader **)dub_checksdata(L, 1, "ofURLFileLoader"));
    string *url = *((string **)dub_checksdata(L, 2, "string"));
    string *path = *((string **)dub_checksdata(L, 3, "string"));
    dub_pushudata(L, new ofHttpResponse(self->saveTo(*url, *path)), "ofHttpResponse", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofURLFileLoader_saveAsync(lua_State *L) {
  try {
    ...
    string *url = *((string **)dub_checksdata(L, 2, "string"));
    string *path = *((string **)dub_checksdata(L, 3, "string"));
    lua_pushnumber(L, self->saveAsync(*url, *path));
    return 1;
  } catch (std::exception &e) {
