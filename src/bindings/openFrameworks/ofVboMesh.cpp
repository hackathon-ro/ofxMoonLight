 ...
 * 
 */
static int ofVboMesh__ofVboMesh(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub_checksdata_d(L, 1, "ofVboMesh"));
    if (userdata->gc) {
      ofVboMesh *self = (ofVboMesh *)userdata->ptr;
      delete self;
    }
    userdata->gc = false;
    return 0;
 ...
 * 
 */
static int ofVboMesh__cast_(lua_State *L) {

  ofVboMesh *self = *((ofVboMesh **)dub_checksdata_n(L, 1, "ofVboMesh"));
  const char *key = luaL_checkstring(L, 2);
  void **retval__ = (void**)lua_newuserdata(L, sizeof(void*));
  int key_h = dub_hash(key, 2);
  switch(key_h) {
    case 0: {
      if (DUB_ASSERT_KEY(key, "ofMesh")) break;
      *retval__ = static_cast<ofMesh *>(self);
      return 1;
    }
  }
  return 0;
...
/** ofVboMesh::ofVboMesh()
 * api/openFrameworks/gl/ofVboMesh.h:9
 */
static int ofVboMesh_ofVboMesh(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 1) {
      ofMesh *mom = *((ofMesh **)dub_checksdata(L, 1, "ofMesh"));
      ofVboMesh *retval__ = new ofVboMesh(*mom);
      dub_pushudata(L, retval__, "ofVboMesh", true);
      return 1;
    } else {
      ofVboMesh *retval__ = new ofVboMesh();
      dub_pushudata(L, retval__, "ofVboMesh", true);
      return 1;
    }
  } catch (std::exception &e) {
 ...
 * api/openFrameworks/gl/ofVboMesh.h:11
 */
static int ofVboMesh_setUsage(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    int usage = dub_checkint(L, 2);
    self->setUsage(usage);
    return 0;
  } catch (std::exception &e) {
    lua_pushfstring(L, "setUsage: %s", e.what());
  } catch (...) {
    lua_pushfstring(L, "setUsage: Unknown exception");
  }
  return dub_error(L);
}

/** void ofVboMesh::enableColors()
 * api/openFrameworks/gl/ofVboMesh.h:13
 */
static int ofVboMesh_enableColors(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->enableColors();
    return 0;
 ...
 * api/openFrameworks/gl/ofVboMesh.h:14
 */
static int ofVboMesh_enableTextures(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->enableTextures();
    return 0;
 ...
 * api/openFrameworks/gl/ofVboMesh.h:15
 */
static int ofVboMesh_enableNormals(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->enableNormals();
    return 0;
 ...
 * api/openFrameworks/gl/ofVboMesh.h:16
 */
static int ofVboMesh_enableIndices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->enableIndices();
    return 0;
 ...
 * api/openFrameworks/gl/ofVboMesh.h:18
 */
static int ofVboMesh_disableColors(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->disableColors();
    return 0;
 ...
 * api/openFrameworks/gl/ofVboMesh.h:19
 */
static int ofVboMesh_disableTextures(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 * api/openFrameworks/gl/ofVboMesh.h:20
 */
static int ofVboMesh_disableNormals(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->disableNormals();
    return 0;
 ...
 * api/openFrameworks/gl/ofVboMesh.h:21
 */
static int ofVboMesh_disableIndices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->disableIndices();
    return 0;
 ...
 * api/openFrameworks/gl/ofVboMesh.h:23
 */
static int ofVboMesh_usingColors(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 * api/openFrameworks/gl/ofVboMesh.h:24
 */
static int ofVboMesh_usingTextures(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 * api/openFrameworks/gl/ofVboMesh.h:25
 */
static int ofVboMesh_usingNormals(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 * api/openFrameworks/gl/ofVboMesh.h:26
 */
static int ofVboMesh_usingIndices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_setMode(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getMode(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_clear(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->clear();
    return 0;
 ...
 */
static int ofVboMesh_setupIndicesAuto(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getVertex(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_addVertex(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_addVertices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
 ...
 */
static int ofVboMesh_removeVertex(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_setVertex(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *index = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_clearVertices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->clearVertices();
    return 0;
 ...
 */
static int ofVboMesh_getNormal(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *i = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_addNormal(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_addNormals(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
 ...
 */
static int ofVboMesh_removeNormal(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *index = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_setNormal(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *index = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_clearNormals(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->clearNormals();
    return 0;
 ...
 */
static int ofVboMesh_getColor(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *i = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_addColor(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_addColors(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
 ...
 */
static int ofVboMesh_removeColor(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *index = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_setColor(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *index = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_clearColors(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->clearColors();
    return 0;
 ...
 */
static int ofVboMesh_getTexCoord(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *i = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_addTexCoord(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_addTexCoords(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
 ...
 */
static int ofVboMesh_removeTexCoord(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *index = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_setTexCoord(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *index = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_clearTexCoords(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->clearTexCoords();
    return 0;
 ...
 */
static int ofVboMesh_getIndex(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *i = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_addIndex(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *i = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
    self->addIndex(*i);
 ...
 */
static int ofVboMesh_addIndices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
 ...
 */
static int ofVboMesh_removeIndex(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *index = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_setIndex(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    ofIndexType *index = *((ofIndexType **)dub_checksdata(L, 2, "ofIndexType"));
 ...
 */
static int ofVboMesh_clearIndices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->clearIndices();
    return 0;
 ...
 */
static int ofVboMesh_addTriangle(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getNumVertices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getNumColors(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getNumNormals(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getNumTexCoords(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getNumIndices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getVerticesPointer(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getColorsPointer(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getNormalsPointer(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getTexCoordsPointer(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getIndexPointer(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getVertices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getColors(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getNormals(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getTexCoords(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getIndices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_getCentroid(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_setName(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_haveVertsChanged(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_haveColorsChanged(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_haveNormalsChanged(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_haveTexCoordsChanged(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_haveIndicesChanged(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_hasVertices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_hasColors(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_hasNormals(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_hasTexCoords(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_hasIndices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_drawVertices(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->drawVertices();
    return 0;
 ...
 */
static int ofVboMesh_drawWireframe(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->drawWireframe();
    return 0;
 ...
 */
static int ofVboMesh_drawFaces(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->drawFaces();
    return 0;
 ...
 */
static int ofVboMesh_draw(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    self->draw();
    return 0;
 ...
 */
static int ofVboMesh_load(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
 ...
 */
static int ofVboMesh_save(lua_State *L) {
  try {
    ofVboMesh *self = *((ofVboMesh **)dub_checksdata(L, 1, "ofVboMesh"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
...
// --=============================================== __tostring
static int ofVboMesh___tostring(lua_State *L) {
  ofVboMesh *self = *((ofVboMesh **)dub_checksdata_n(L, 1, "ofVboMesh"));
  lua_pushfstring(L, "ofVboMesh: %p", self);
...
static const struct luaL_Reg ofVboMesh_member_methods[] = {
  { "__gc"         , ofVboMesh__ofVboMesh },
  { "_cast_"       , ofVboMesh__cast_     },
  { "new"          , ofVboMesh_ofVboMesh  },
  { "setUsage"     , ofVboMesh_setUsage   },
  { "enableColors" , ofVboMesh_enableColors },
  { "enableTextures", ofVboMesh_enableTextures },
  { "enableNormals", ofVboMesh_enableNormals },
  { "enableIndices", ofVboMesh_enableIndices },
  { "disableColors", ofVboMesh_disableColors },
  { "disableTextures", ofVboMesh_disableTextures },
  { "disableNormals", ofVboMesh_disableNormals },
  { "disableIndices", ofVboMesh_disableIndices },
  { "usingColors"  , ofVboMesh_usingColors },
  { "usingTextures", ofVboMesh_usingTextures },
  { "usingNormals" , ofVboMesh_usingNormals },
  { "usingIndices" , ofVboMesh_usingIndices },
  { "setMode"      , ofVboMesh_setMode    },
  { "getMode"      , ofVboMesh_getMode    },
  { "clear"        , ofVboMesh_clear      },
  { "setupIndicesAuto", ofVboMesh_setupIndicesAuto },
  { "getVertex"    , ofVboMesh_getVertex  },
  { "addVertex"    , ofVboMesh_addVertex  },
  { "addVertices"  , ofVboMesh_addVertices },
  { "removeVertex" , ofVboMesh_removeVertex },
  { "setVertex"    , ofVboMesh_setVertex  },
  { "clearVertices", ofVboMesh_clearVertices },
  { "getNormal"    , ofVboMesh_getNormal  },
  { "addNormal"    , ofVboMesh_addNormal  },
  { "addNormals"   , ofVboMesh_addNormals },
  { "removeNormal" , ofVboMesh_removeNormal },
  { "setNormal"    , ofVboMesh_setNormal  },
  { "clearNormals" , ofVboMesh_clearNormals },
  { "getColor"     , ofVboMesh_getColor   },
  { "addColor"     , ofVboMesh_addColor   },
  { "addColors"    , ofVboMesh_addColors  },
  { "removeColor"  , ofVboMesh_removeColor },
  { "setColor"     , ofVboMesh_setColor   },
  { "clearColors"  , ofVboMesh_clearColors },
  { "getTexCoord"  , ofVboMesh_getTexCoord },
  { "addTexCoord"  , ofVboMesh_addTexCoord },
  { "addTexCoords" , ofVboMesh_addTexCoords },
  { "removeTexCoord", ofVboMesh_removeTexCoord },
  { "setTexCoord"  , ofVboMesh_setTexCoord },
  { "clearTexCoords", ofVboMesh_clearTexCoords },
  { "getIndex"     , ofVboMesh_getIndex   },
  { "addIndex"     , ofVboMesh_addIndex   },
  { "addIndices"   , ofVboMesh_addIndices },
  { "removeIndex"  , ofVboMesh_removeIndex },
  { "setIndex"     , ofVboMesh_setIndex   },
  { "clearIndices" , ofVboMesh_clearIndices },
  { "addTriangle"  , ofVboMesh_addTriangle },
  { "getNumVertices", ofVboMesh_getNumVertices },
  { "getNumColors" , ofVboMesh_getNumColors },
  { "getNumNormals", ofVboMesh_getNumNormals },
  { "getNumTexCoords", ofVboMesh_getNumTexCoords },
  { "getNumIndices", ofVboMesh_getNumIndices },
  { "getVerticesPointer", ofVboMesh_getVerticesPointer },
  { "getColorsPointer", ofVboMesh_getColorsPointer },
  { "getNormalsPointer", ofVboMesh_getNormalsPointer },
  { "getTexCoordsPointer", ofVboMesh_getTexCoordsPointer },
  { "getIndexPointer", ofVboMesh_getIndexPointer },
  { "getVertices"  , ofVboMesh_getVertices },
  { "getColors"    , ofVboMesh_getColors  },
  { "getNormals"   , ofVboMesh_getNormals },
  { "getTexCoords" , ofVboMesh_getTexCoords },
  { "getIndices"   , ofVboMesh_getIndices },
  { "getCentroid"  , ofVboMesh_getCentroid },
  { "setName"      , ofVboMesh_setName    },
  { "haveVertsChanged", ofVboMesh_haveVertsChanged },
  { "haveColorsChanged", ofVboMesh_haveColorsChanged },
  { "haveNormalsChanged", ofVboMesh_haveNormalsChanged },
  { "haveTexCoordsChanged", ofVboMesh_haveTexCoordsChanged },
  { "haveIndicesChanged", ofVboMesh_haveIndicesChanged },
  { "hasVertices"  , ofVboMesh_hasVertices },
  { "hasColors"    , ofVboMesh_hasColors  },
  { "hasNormals"   , ofVboMesh_hasNormals },
  { "hasTexCoords" , ofVboMesh_hasTexCoords },
  { "hasIndices"   , ofVboMesh_hasIndices },
  { "drawVertices" , ofVboMesh_drawVertices },
  { "drawWireframe", ofVboMesh_drawWireframe },
  { "drawFaces"    , ofVboMesh_drawFaces  },
  { "draw"         , ofVboMesh_draw       },
  { "load"         , ofVboMesh_load       },
  { "save"         , ofVboMesh_save       },
  { "__tostring"   , ofVboMesh___tostring },
  { "deleted"      , dub_isDeleted        },
  { NULL, NULL},
};


extern "C" int luaopen_ofVboMesh(lua_State *L)
{
  // Create the metatable which will contain all the member methods
  luaL_newmetatable(L, "ofVboMesh");
  // <mt>

  // register member methods
  luaL_register(L, NULL, ofVboMesh_member_methods);
  // save meta-table in _G
  dub_register(L, "_G", "ofVboMesh", "ofVboMesh");
  // <mt>
  lua_pop(L, 1);
  return 0;
}
