...
static int ofFilePath_getFileExt(lua_State *L) {
  try {
    ...
    dub_pushudata(L, new string(ofFilePath::getFileExt(*filename)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_removeExt(lua_State *L) {
  try {
    string *filename = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofFilePath::removeExt(*filename)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_addLeadingSlash(lua_State *L) {
  try {
    ...
    dub_pushudata(L, new string(ofFilePath::addLeadingSlash(*path)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_addTrailingSlash(lua_State *L) {
  try {
    string *path = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofFilePath::addTrailingSlash(*path)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_removeTrailingSlash(lua_State *L) {
  try {
    string *path = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofFilePath::removeTrailingSlash(*path)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_getPathForDirectory(lua_State *L) {
  try {
    string *path = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofFilePath::getPathForDirectory(*path)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_getAbsolutePath(lua_State *L) {
  try {
    ...
    if (top__ >= 2) {
      ...
      dub_pushudata(L, new string(ofFilePath::getAbsolutePath(*path, bRelativeToData)), "string", true);
      return 1;
    } else {
      string *path = *((string **)dub_checksdata(L, 1, "string"));
      dub_pushudata(L, new string(ofFilePath::getAbsolutePath(*path)), "string", true);
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofFilePath_isAbsolute(lua_State *L) {
  try {
    string *path = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushboolean(L, ofFilePath::isAbsolute(*path));
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_getFileName(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
      string *filePath = *((string **)dub_checksdata(L, 1, "string"));
      bool bRelativeToData = dub_checkboolean(L, 2);
      dub_pushudata(L, new string(ofFilePath::getFileName(*filePath, bRelativeToData)), "string", true);
      return 1;
    } else {
      string *filePath = *((string **)dub_checksdata(L, 1, "string"));
      dub_pushudata(L, new string(ofFilePath::getFileName(*filePath)), "string", true);
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofFilePath_getBaseName(lua_State *L) {
  try {
    string *filePath = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofFilePath::getBaseName(*filePath)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_getEnclosingDirectory(lua_State *L) {
  try {
    ...
    if (top__ >= 2) {
      string *filePath = *((string **)dub_checksdata(L, 1, "string"));
      bool bRelativeToData = dub_checkboolean(L, 2);
      dub_pushudata(L, new string(ofFilePath::getEnclosingDirectory(*filePath, bRelativeToData)), "string", true);
      return 1;
    } else {
      string *filePath = *((string **)dub_checksdata(L, 1, "string"));
      dub_pushudata(L, new string(ofFilePath::getEnclosingDirectory(*filePath)), "string", true);
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofFilePath_getCurrentWorkingDirectory(lua_State *L) {
  try {
    dub_pushudata(L, new string(ofFilePath::getCurrentWorkingDirectory()), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_join(lua_State *L) {
  try {
    string *path1 = *((string **)dub_checksdata(L, 1, "string"));
    string *path2 = *((string **)dub_checksdata(L, 2, "string"));
    dub_pushudata(L, new string(ofFilePath::join(*path1, *path2)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_getCurrentExePath(lua_State *L) {
  try {
    dub_pushudata(L, new string(ofFilePath::getCurrentExePath()), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_getCurrentExeDir(lua_State *L) {
  try {
    dub_pushudata(L, new string(ofFilePath::getCurrentExeDir()), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFilePath_getUserHomeDir(lua_State *L) {
  try {
    dub_pushudata(L, new string(ofFilePath::getUserHomeDir()), "string", true);
    return 1;
  } catch (std::exception &e) {
