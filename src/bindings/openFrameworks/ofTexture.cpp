...
static int ofTexture_setUseExternalTextureID(lua_State *L) {
  try {
    ofTexture *self = *((ofTexture **)dub_checksdata(L, 1, "ofTexture"));
    GLuint *externTexID = *((GLuint **)dub_checksdata(L, 2, "GLuint"));
...
static int ofTexture_setTextureWrap(lua_State *L) {
  try {
    ofTexture *self = *((ofTexture **)dub_checksdata(L, 1, "ofTexture"));
    GLint *wrapModeHorizontal = *((GLint **)dub_checksdata(L, 2, "GLint"));
    GLint *wrapModeVertical = *((GLint **)dub_checksdata(L, 3, "GLint"));
...
static int ofTexture_setTextureMinMagFilter(lua_State *L) {
  try {
    ofTexture *self = *((ofTexture **)dub_checksdata(L, 1, "ofTexture"));
    GLint *minFilter = *((GLint **)dub_checksdata(L, 2, "GLint"));
    GLint *maxFilter = *((GLint **)dub_checksdata(L, 3, "GLint"));
