...
static int ofFile_ofFile(lua_State *L) {
  try {
    ...
    if (top__ >= 3) {
      ...
      ofFile *retval__ = new ofFile(*filePath, mode, binary);
      dub_pushudata(L, retval__, "ofFile", true);
      return 1;
    } else if (top__ >= 2) {
      string *filePath = *((string **)dub_checksdata(L, 1, "string"));
      ofFile::Mode mode = (ofFile::Mode)dub_checkint(L, 2);
      ofFile *retval__ = new ofFile(*filePath, mode);
      dub_pushudata(L, retval__, "ofFile", true);
      return 1;
    } else if (top__ >= 1) {
      ...
      if ( (ptr1__ = dub_issdata(L, 1, "ofFile", type__)) ) {
        ...
        string *filePath = *((string **)dub_checksdata(L, 1, "string"));
        ofFile *retval__ = new ofFile(*filePath);
        dub_pushudata(L, retval__, "ofFile", true);
        return 1;
      }
    } else {
...
static int ofFile_open(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      lua_pushboolean(L, self->open(*path, mode, binary));
      return 1;
    } else if (top__ >= 3) {
      string *path = *((string **)dub_checksdata(L, 2, "string"));
      ofFile::Mode mode = (ofFile::Mode)dub_checkint(L, 3);
      lua_pushboolean(L, self->open(*path, mode));
      return 1;
    } else {
      string *path = *((string **)dub_checksdata(L, 2, "string"));
      lua_pushboolean(L, self->open(*path));
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofFile_getExtension(lua_State *L) {
  try {
    ofFile *self = *((ofFile **)dub_checksdata(L, 1, "ofFile"));
    dub_pushudata(L, new string(self->getExtension()), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFile_getFileName(lua_State *L) {
  try {
    ofFile *self = *((ofFile **)dub_checksdata(L, 1, "ofFile"));
    dub_pushudata(L, new string(self->getFileName()), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFile_getBaseName(lua_State *L) {
  try {
    ofFile *self = *((ofFile **)dub_checksdata(L, 1, "ofFile"));
    dub_pushudata(L, new string(self->getBaseName()), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFile_getEnclosingDirectory(lua_State *L) {
  try {
    ofFile *self = *((ofFile **)dub_checksdata(L, 1, "ofFile"));
    dub_pushudata(L, new string(self->getEnclosingDirectory()), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFile_copyFromTo(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 4) {
      string *pathSrc = *((string **)dub_checksdata(L, 1, "string"));
      string *pathDst = *((string **)dub_checksdata(L, 2, "string"));
      bool bRelativeToData = dub_checkboolean(L, 3);
      bool overwrite = dub_checkboolean(L, 4);
      lua_pushboolean(L, ofFile::copyFromTo(*pathSrc, *pathDst, bRelativeToData, overwrite));
      return 1;
    } else if (top__ >= 3) {
      string *pathSrc = *((string **)dub_checksdata(L, 1, "string"));
      string *pathDst = *((string **)dub_checksdata(L, 2, "string"));
      bool bRelativeToData = dub_checkboolean(L, 3);
      lua_pushboolean(L, ofFile::copyFromTo(*pathSrc, *pathDst, bRelativeToData));
      return 1;
    } else {
      string *pathSrc = *((string **)dub_checksdata(L, 1, "string"));
      string *pathDst = *((string **)dub_checksdata(L, 2, "string"));
      lua_pushboolean(L, ofFile::copyFromTo(*pathSrc, *pathDst));
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofFile_moveFromTo(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      bool bRelativeToData = dub_checkboolean(L, 3);
      bool overwrite = dub_checkboolean(L, 4);
      lua_pushboolean(L, ofFile::moveFromTo(*pathSrc, *pathDst, bRelativeToData, overwrite));
      return 1;
    } else if (top__ >= 3) {
      string *pathSrc = *((string **)dub_checksdata(L, 1, "string"));
      string *pathDst = *((string **)dub_checksdata(L, 2, "string"));
      bool bRelativeToData = dub_checkboolean(L, 3);
      lua_pushboolean(L, ofFile::moveFromTo(*pathSrc, *pathDst, bRelativeToData));
      return 1;
    } else {
      string *pathSrc = *((string **)dub_checksdata(L, 1, "string"));
      string *pathDst = *((string **)dub_checksdata(L, 2, "string"));
      lua_pushboolean(L, ofFile::moveFromTo(*pathSrc, *pathDst));
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofFile_doesFileExist(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
      string *fPath = *((string **)dub_checksdata(L, 1, "string"));
      bool bRelativeToData = dub_checkboolean(L, 2);
      lua_pushboolean(L, ofFile::doesFileExist(*fPath, bRelativeToData));
      return 1;
    } else {
      string *fPath = *((string **)dub_checksdata(L, 1, "string"));
      lua_pushboolean(L, ofFile::doesFileExist(*fPath));
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofFile_removeFile(lua_State *L) {
  try {
    ...
    if (top__ >= 2) {
      ...
      bool bRelativeToData = dub_checkboolean(L, 2);
      lua_pushboolean(L, ofFile::removeFile(*path, bRelativeToData));
      return 1;
    } else {
      string *path = *((string **)dub_checksdata(L, 1, "string"));
      lua_pushboolean(L, ofFile::removeFile(*path));
      return 1;
    }
  } catch (std::exception &e) {
