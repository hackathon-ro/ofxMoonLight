...
static int ofShader_load(lua_State *L) {
  try {
    ...
    int top__ = lua_gettop(L);
    if (top__ >= 4) {
      string *vertName = *((string **)dub_checksdata(L, 2, "string"));
      string *fragName = *((string **)dub_checksdata(L, 3, "string"));
      string *geomName = *((string **)dub_checksdata(L, 4, "string"));
      lua_pushboolean(L, self->load(*vertName, *fragName, *geomName));
      return 1;
    } else if (top__ >= 3) {
      string *vertName = *((string **)dub_checksdata(L, 2, "string"));
      string *fragName = *((string **)dub_checksdata(L, 3, "string"));
      lua_pushboolean(L, self->load(*vertName, *fragName));
      return 1;
    } else {
      string *shaderName = *((string **)dub_checksdata(L, 2, "string"));
      lua_pushboolean(L, self->load(*shaderName));
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofShader_setGeometryInputType(lua_State *L) {
  try {
    ofShader *self = *((ofShader **)dub_checksdata(L, 1, "ofShader"));
    GLenum *type = *((GLenum **)dub_checksdata(L, 2, "GLenum"));
...
static int ofShader_setUniformTexture(lua_State *L) {
  try {
    ...
    if (top__ >= 5) {
      ...
      GLint *textureID = *((GLint **)dub_checksdata(L, 4, "GLint"));
...
static int ofShader_setUniform1iv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      const char *name = dub_checkstring(L, 2);
      int *v = *((int **)dub_checksdata(L, 3, "int"));
      int count = dub_checkint(L, 4);
      self->setUniform1iv(name, v, count);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      int *v = *((int **)dub_checksdata(L, 3, "int"));
      self->setUniform1iv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setUniform2iv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      int *v = *((int **)dub_checksdata(L, 3, "int"));
      int count = dub_checkint(L, 4);
      self->setUniform2iv(name, v, count);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      int *v = *((int **)dub_checksdata(L, 3, "int"));
      self->setUniform2iv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setUniform3iv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      int *v = *((int **)dub_checksdata(L, 3, "int"));
      int count = dub_checkint(L, 4);
      self->setUniform3iv(name, v, count);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      int *v = *((int **)dub_checksdata(L, 3, "int"));
      self->setUniform3iv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setUniform4iv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      int *v = *((int **)dub_checksdata(L, 3, "int"));
      int count = dub_checkint(L, 4);
      self->setUniform4iv(name, v, count);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      int *v = *((int **)dub_checksdata(L, 3, "int"));
      self->setUniform4iv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setUniform1fv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      const char *name = dub_checkstring(L, 2);
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      int count = dub_checkint(L, 4);
      self->setUniform1fv(name, v, count);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      self->setUniform1fv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setUniform2fv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      int count = dub_checkint(L, 4);
      self->setUniform2fv(name, v, count);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      self->setUniform2fv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setUniform3fv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      int count = dub_checkint(L, 4);
      self->setUniform3fv(name, v, count);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      self->setUniform3fv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setUniform4fv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      int count = dub_checkint(L, 4);
      self->setUniform4fv(name, v, count);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      self->setUniform4fv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_getAttributeLocation(lua_State *L) {
  try {
    ofShader *self = *((ofShader **)dub_checksdata(L, 1, "ofShader"));
    const char *name = dub_checkstring(L, 2);
    dub_pushudata(L, new GLint(self->getAttributeLocation(name)), "GLint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofShader_setAttribute1s(lua_State *L) {
  try {
    ofShader *self = *((ofShader **)dub_checksdata(L, 1, "ofShader"));
    GLint *location = *((GLint **)dub_checksdata(L, 2, "GLint"));
...
static int ofShader_setAttribute1fv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      self->setAttribute1fv(name, v, *stride);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      self->setAttribute1fv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setAttribute2fv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      GLsizei *stride = *((GLsizei **)dub_checksdata(L, 4, "GLsizei"));
      self->setAttribute2fv(name, v, *stride);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      self->setAttribute2fv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setAttribute3fv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      GLsizei *stride = *((GLsizei **)dub_checksdata(L, 4, "GLsizei"));
      self->setAttribute3fv(name, v, *stride);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      self->setAttribute3fv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setAttribute4fv(lua_State *L) {
  try {
    ...
    if (top__ >= 4) {
      ...
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      GLsizei *stride = *((GLsizei **)dub_checksdata(L, 4, "GLsizei"));
      self->setAttribute4fv(name, v, *stride);
      return 0;
    } else {
      const char *name = dub_checkstring(L, 2);
      float *v = *((float **)dub_checksdata(L, 3, "float"));
      self->setAttribute4fv(name, v);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofShader_setupShaderFromSource(lua_State *L) {
  try {
    ofShader *self = *((ofShader **)dub_checksdata(L, 1, "ofShader"));
    GLenum *type = *((GLenum **)dub_checksdata(L, 2, "GLenum"));
    string *source = *((string **)dub_checksdata(L, 3, "string"));
    lua_pushboolean(L, self->setupShaderFromSource(*type, *source));
    return 1;
  } catch (std::exception &e) {
...
static int ofShader_setupShaderFromFile(lua_State *L) {
  try {
    ofShader *self = *((ofShader **)dub_checksdata(L, 1, "ofShader"));
    GLenum *type = *((GLenum **)dub_checksdata(L, 2, "GLenum"));
    string *filename = *((string **)dub_checksdata(L, 3, "string"));
    lua_pushboolean(L, self->setupShaderFromFile(*type, *filename));
    return 1;
  } catch (std::exception &e) {
...
static int ofShader_getProgram(lua_State *L) {
  try {
    ofShader *self = *((ofShader **)dub_checksdata(L, 1, "ofShader"));
    dub_pushudata(L, &self->getProgram(), "GLuint", false);
    return 1;
  } catch (std::exception &e) {
...
static int ofShader_getShader(lua_State *L) {
  try {
    ofShader *self = *((ofShader **)dub_checksdata(L, 1, "ofShader"));
    GLenum *type = *((GLenum **)dub_checksdata(L, 2, "GLenum"));
    dub_pushudata(L, &self->getShader(*type), "GLuint", false);
    return 1;
  } catch (std::exception &e) {
