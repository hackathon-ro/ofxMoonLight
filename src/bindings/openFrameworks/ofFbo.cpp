...
static int ofFbo_getFbo(lua_State *L) {
  try {
    ofFbo *self = *((ofFbo **)dub_checksdata(L, 1, "ofFbo"));
    dub_pushudata(L, new GLuint(self->getFbo()), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFbo_getDepthBuffer(lua_State *L) {
  try {
    ofFbo *self = *((ofFbo **)dub_checksdata(L, 1, "ofFbo"));
    dub_pushudata(L, new GLuint(self->getDepthBuffer()), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofFbo_getStencilBuffer(lua_State *L) {
  try {
    ofFbo *self = *((ofFbo **)dub_checksdata(L, 1, "ofFbo"));
    dub_pushudata(L, new GLuint(self->getStencilBuffer()), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
