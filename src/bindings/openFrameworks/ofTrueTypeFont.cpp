...
static int ofTrueTypeFont_loadFont(lua_State *L) {
  try {
    ...
    if (top__ >= 8) {
      ...
      lua_pushboolean(L, self->loadFont(*filename, fontsize, _bAntiAliased, _bFullCharacterSet, makeContours, simplifyAmt, dpi));
      return 1;
    } else if (top__ >= 7) {
      string *filename = *((string **)dub_checksdata(L, 2, "string"));
      int fontsize = dub_checkint(L, 3);
      ...
      bool makeContours = dub_checkboolean(L, 6);
      float simplifyAmt = dub_checknumber(L, 7);
      lua_pushboolean(L, self->loadFont(*filename, fontsize, _bAntiAliased, _bFullCharacterSet, makeContours, simplifyAmt));
      return 1;
    } else if (top__ >= 6) {
      string *filename = *((string **)dub_checksdata(L, 2, "string"));
      int fontsize = dub_checkint(L, 3);
      ...
      bool _bFullCharacterSet = dub_checkboolean(L, 5);
      bool makeContours = dub_checkboolean(L, 6);
      lua_pushboolean(L, self->loadFont(*filename, fontsize, _bAntiAliased, _bFullCharacterSet, makeContours));
      return 1;
    } else if (top__ >= 5) {
      string *filename = *((string **)dub_checksdata(L, 2, "string"));
      int fontsize = dub_checkint(L, 3);
      bool _bAntiAliased = dub_checkboolean(L, 4);
      bool _bFullCharacterSet = dub_checkboolean(L, 5);
      lua_pushboolean(L, self->loadFont(*filename, fontsize, _bAntiAliased, _bFullCharacterSet));
      return 1;
    } else if (top__ >= 4) {
      string *filename = *((string **)dub_checksdata(L, 2, "string"));
      int fontsize = dub_checkint(L, 3);
      bool _bAntiAliased = dub_checkboolean(L, 4);
      lua_pushboolean(L, self->loadFont(*filename, fontsize, _bAntiAliased));
      return 1;
    } else {
      string *filename = *((string **)dub_checksdata(L, 2, "string"));
      int fontsize = dub_checkint(L, 3);
      lua_pushboolean(L, self->loadFont(*filename, fontsize));
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofTrueTypeFont_stringWidth(lua_State *L) {
  try {
    ofTrueTypeFont *self = *((ofTrueTypeFont **)dub_checksdata(L, 1, "ofTrueTypeFont"));
    string *s = *((string **)dub_checksdata(L, 2, "string"));
    lua_pushnumber(L, self->stringWidth(*s));
    return 1;
  } catch (std::exception &e) {
...
static int ofTrueTypeFont_stringHeight(lua_State *L) {
  try {
    ofTrueTypeFont *self = *((ofTrueTypeFont **)dub_checksdata(L, 1, "ofTrueTypeFont"));
    string *s = *((string **)dub_checksdata(L, 2, "string"));
    lua_pushnumber(L, self->stringHeight(*s));
    return 1;
  } catch (std::exception &e) {
...
static int ofTrueTypeFont_getStringBoundingBox(lua_State *L) {
  try {
    ...
    dub_pushudata(L, new ofRectangle(self->getStringBoundingBox(*s, x, y)), "ofRectangle", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofTrueTypeFont_getStringAsPoints(lua_State *L) {
  try {
    ofTrueTypeFont *self = *((ofTrueTypeFont **)dub_checksdata(L, 1, "ofTrueTypeFont"));
    string *str = *((string **)dub_checksdata(L, 2, "string"));
    dub_pushudata(L, new vector< ofTTFCharacter >(self->getStringAsPoints(*str)), "vector< ofTTFCharacter >", true);
    return 1;
  } catch (std::exception &e) {
