...
static int ofVbo_setVertexData(lua_State *L) {
  try {
    ...
    if (top__ >= 6) {
      ...
      int total = dub_checkint(L, 4);
      int usage = dub_checkint(L, 5);
      self->setVertexData(vert0x, numCoords, total, usage);
      return 0;
    } else {
...
static int ofVbo_setColorData(lua_State *L) {
  try {
    ...
    int top__ = lua_gettop(L);
    if (top__ >= 5) {
      float *color0r = *((float **)dub_checksdata(L, 2, "float"));
      int total = dub_checkint(L, 3);
      int usage = dub_checkint(L, 4);
      int stride = dub_checkint(L, 5);
      self->setColorData(color0r, total, usage, stride);
      return 0;
    } else {
      int type__ = lua_type(L, 2);
      void **ptr2__;
      if ( (ptr2__ = dub_issdata(L, 2, "ofFloatColor", type__)) ) {
        ...
        int total = dub_checkint(L, 3);
        int usage = dub_checkint(L, 4);
        self->setColorData(color0r, total, usage);
        return 0;
      }
    }
  } catch (std::exception &e) {
...
static int ofVbo_setNormalData(lua_State *L) {
  try {
    ...
    int top__ = lua_gettop(L);
    if (top__ >= 5) {
      float *normal0x = *((float **)dub_checksdata(L, 2, "float"));
      int total = dub_checkint(L, 3);
      int usage = dub_checkint(L, 4);
      int stride = dub_checkint(L, 5);
      self->setNormalData(normal0x, total, usage, stride);
      return 0;
    } else {
      int type__ = lua_type(L, 2);
      void **ptr2__;
      if ( (ptr2__ = dub_issdata(L, 2, "ofVec3f", type__)) ) {
        ...
        int total = dub_checkint(L, 3);
        int usage = dub_checkint(L, 4);
        self->setNormalData(normal0x, total, usage);
        return 0;
      }
    }
  } catch (std::exception &e) {
...
static int ofVbo_setTexCoordData(lua_State *L) {
  try {
    ...
    int top__ = lua_gettop(L);
    if (top__ >= 5) {
      float *texCoord0x = *((float **)dub_checksdata(L, 2, "float"));
      int total = dub_checkint(L, 3);
      int usage = dub_checkint(L, 4);
      int stride = dub_checkint(L, 5);
      self->setTexCoordData(texCoord0x, total, usage, stride);
      return 0;
    } else {
      int type__ = lua_type(L, 2);
      void **ptr2__;
      if ( (ptr2__ = dub_issdata(L, 2, "float", type__)) ) {
        float *texCoord0x = *((float **)ptr2__);
        int total = dub_checkint(L, 3);
        int usage = dub_checkint(L, 4);
        self->setTexCoordData(texCoord0x, total, usage);
        return 0;
      } else {
...
static int ofVbo_updateVertexData(lua_State *L) {
  try {
    ...
    if ( (ptr2__ = dub_issdata(L, 2, "ofVec3f", type__)) ) {
      ...
      float *ver0x = *((float **)dub_checksdata(L, 2, "float"));
      int total = dub_checkint(L, 3);
      self->updateVertexData(ver0x, total);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofVbo_updateColorData(lua_State *L) {
  try {
    ...
    if ( (ptr2__ = dub_issdata(L, 2, "ofFloatColor", type__)) ) {
      ...
      float *color0r = *((float **)dub_checksdata(L, 2, "float"));
      int total = dub_checkint(L, 3);
      self->updateColorData(color0r, total);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofVbo_updateNormalData(lua_State *L) {
  try {
    ...
    if ( (ptr2__ = dub_issdata(L, 2, "ofVec3f", type__)) ) {
      ...
      float *normal0x = *((float **)dub_checksdata(L, 2, "float"));
      int total = dub_checkint(L, 3);
      self->updateNormalData(normal0x, total);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofVbo_updateTexCoordData(lua_State *L) {
  try {
    ...
    if ( (ptr2__ = dub_issdata(L, 2, "float", type__)) ) {
      float *texCoord0x = *((float **)ptr2__);
      int total = dub_checkint(L, 3);
      self->updateTexCoordData(texCoord0x, total);
      return 0;
    } else {
      ofVec2f *texCoords = *((ofVec2f **)dub_checksdata(L, 2, "ofVec2f"));
      int total = dub_checkint(L, 3);
...
static int ofVbo_getVertId(lua_State *L) {
  try {
    ofVbo *self = *((ofVbo **)dub_checksdata(L, 1, "ofVbo"));
    dub_pushudata(L, new GLuint(self->getVertId()), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofVbo_getColorId(lua_State *L) {
  try {
    ofVbo *self = *((ofVbo **)dub_checksdata(L, 1, "ofVbo"));
    dub_pushudata(L, new GLuint(self->getColorId()), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofVbo_getNormalId(lua_State *L) {
  try {
    ofVbo *self = *((ofVbo **)dub_checksdata(L, 1, "ofVbo"));
    dub_pushudata(L, new GLuint(self->getNormalId()), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofVbo_getTexCoordId(lua_State *L) {
  try {
    ofVbo *self = *((ofVbo **)dub_checksdata(L, 1, "ofVbo"));
    dub_pushudata(L, new GLuint(self->getTexCoordId()), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofVbo_getIndexId(lua_State *L) {
  try {
    ofVbo *self = *((ofVbo **)dub_checksdata(L, 1, "ofVbo"));
    dub_pushudata(L, new GLuint(self->getIndexId()), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
