...
#include "api/openFrameworks/3d/ofCamera.h"
#include "api/openFrameworks/types/ofColor.h"
#include "api/openFrameworks/3d/ofEasyCam.h"
#include "api/openFrameworks/events/ofEvents.h"
#include "api/openFrameworks/gl/ofFbo.h"
...
#include "api/openFrameworks/gl/ofMaterial.h"
#include "api/openFrameworks/math/ofMatrix3x3.h"
#include "api/openFrameworks/math/ofMatrix4x4.h"
#include "api/openFrameworks/3d/ofMesh.h"
#include "api/openFrameworks/3d/ofNode.h"
#include "api/openFrameworks/graphics/ofPath.h"
#include "api/openFrameworks/graphics/ofPolyline.h"
#include "api/openFrameworks/math/ofQuaternion.h"
#include "api/openFrameworks/types/ofRectangle.h"
#include "api/openFrameworks/gl/ofShader.h"
#include "api/openFrameworks/sound/ofSoundPlayer.h"
#include "api/openFrameworks/sound/ofSoundStream.h"
#include "api/openFrameworks/utils/ofSystemUtils.h"
#include "api/openFrameworks/graphics/ofTessellator.h"
#include "api/openFrameworks/gl/ofTexture.h"
...
#include "api/openFrameworks/gl/ofVbo.h"
#include "api/openFrameworks/gl/ofVboMesh.h"
#include "api/openFrameworks/math/ofVec2f.h"
#include "api/openFrameworks/math/ofVec3f.h"
#include "api/openFrameworks/math/ofVec4f.h"
#include "api/openFrameworks/video/ofVideoGrabber.h"
#include "api/openFrameworks/video/ofVideoPlayer.h"
#include "api/openFrameworks/3d/of3dUtils.h"
#include "api/openFrameworks/app/ofAppRunner.h"
#include "api/openFrameworks/graphics/ofBitmapFont.h"
#include "api/openFrameworks/events/ofEventUtils.h"
#include "api/openFrameworks/gl/ofGLUtils.h"
#include "api/openFrameworks/graphics/ofGraphics.h"
#include "api/openFrameworks/graphics/ofImage.h"
#include "api/openFrameworks/math/ofMath.h"
#include "api/openFrameworks/utils/ofNoise.h"
#include "api/openFrameworks/utils/ofUtils.h"
#include "api/openFrameworks/utils/ofConstants.h"
#include "api/openFrameworks/graphics/ofPixels.h"

using namespace std;

extern "C" {
int luaopen_ofAppBaseWindow(lua_State *L);
int luaopen_ofBaseApp(lua_State *L);
int luaopen_ofBaseDraws(lua_State *L);
int luaopen_ofBaseUpdates(lua_State *L);
int luaopen_ofBaseHasTexture(lua_State *L);
int luaopen_ofAbstractHasPixels(lua_State *L);
int luaopen_ofAbstractImage(lua_State *L);
int luaopen_ofBaseSoundInput(lua_State *L);
int luaopen_ofBaseSoundOutput(lua_State *L);
int luaopen_ofBaseVideo(lua_State *L);
int luaopen_ofBaseVideoDraws(lua_State *L);
int luaopen_ofBaseVideoGrabber(lua_State *L);
int luaopen_ofBaseVideoPlayer(lua_State *L);
int luaopen_ofBaseRenderer(lua_State *L);
...
int luaopen_ofBaseLoggerChannel(lua_State *L);
...
int luaopen_ofFileDialogResult(lua_State *L);
...
int luaopen_charProps(lua_State *L);
int luaopen_ofTrueTypeFont(lua_State *L);
int luaopen_ofSerialDeviceInfo(lua_State *L);
...
int luaopen_ofFloatImage(lua_State *L);
int luaopen_ofShortImage(lua_State *L);
}
...
static int ofSetWindowTitle(lua_State *L) {
  try {
    string *title = *((string **)dub_checksdata(L, 1, "string"));
...
static int ofSendMessage(lua_State *L) {
  try {
    ...
    if ( (ptr1__ = dub_issdata(L, 1, "string", type__)) ) {
      string *messageString = *((string **)ptr1__);
      ofSendMessage(*messageString);
      return 0;
    } else {
...
static int ofBufferFromFile(lua_State *L) {
  try {
    ...
    if (top__ >= 2) {
      ...
      dub_pushudata(L, new ofBuffer(ofBufferFromFile(*path, binary)), "ofBuffer", true);
      return 1;
    } else {
      string *path = *((string **)dub_checksdata(L, 1, "string"));
      dub_pushudata(L, new ofBuffer(ofBufferFromFile(*path)), "ofBuffer", true);
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofBufferToFile(lua_State *L) {
  try {
    ...
    if (top__ >= 3) {
      ...
      lua_pushboolean(L, ofBufferToFile(*path, *buffer, binary));
      return 1;
    } else {
      string *path = *((string **)dub_checksdata(L, 1, "string"));
      ofBuffer *buffer = *((ofBuffer **)dub_checksdata(L, 2, "ofBuffer"));
      lua_pushboolean(L, ofBufferToFile(*path, *buffer));
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofGetGLPolyMode(lua_State *L) {
  try {
    ...
    dub_pushudata(L, new GLuint(ofGetGLPolyMode(m)), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetOFPolyMode(lua_State *L) {
  try {
    GLuint *m = *((GLuint **)dub_checksdata(L, 1, "GLuint"));
...
static int ofGetGLPrimitiveMode(lua_State *L) {
  try {
    ...
    dub_pushudata(L, new GLuint(ofGetGLPrimitiveMode(mode)), "GLuint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetOFPrimitiveMode(lua_State *L) {
  try {
    GLuint *mode = *((GLuint **)dub_checksdata(L, 1, "GLuint"));
...
static int ofCheckGLExtension(lua_State *L) {
  try {
    string *searchName = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushboolean(L, ofCheckGLExtension(*searchName));
    return 1;
  } catch (std::exception &e) {
...
static int ofGetAttrLocationPosition(lua_State *L) {
  try {
    dub_pushudata(L, new GLint(ofGetAttrLocationPosition()), "GLint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetAttrLocationColor(lua_State *L) {
  try {
    dub_pushudata(L, new GLint(ofGetAttrLocationColor()), "GLint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetAttrLocationNormal(lua_State *L) {
  try {
    dub_pushudata(L, new GLint(ofGetAttrLocationNormal()), "GLint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetAttrLocationTexCoord(lua_State *L) {
  try {
    dub_pushudata(L, new GLint(ofGetAttrLocationTexCoord()), "GLint", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofBeginSaveScreenAsPDF(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 4) {
      string *filename = *((string **)dub_checksdata(L, 1, "string"));
      ...
      bool bMultipage = dub_checkboolean(L, 2);
      bool b3D = dub_checkboolean(L, 3);
      ofBeginSaveScreenAsPDF(*filename, bMultipage, b3D);
      return 0;
    } else if (top__ >= 2) {
      string *filename = *((string **)dub_checksdata(L, 1, "string"));
      bool bMultipage = dub_checkboolean(L, 2);
      ofBeginSaveScreenAsPDF(*filename, bMultipage);
      return 0;
    } else {
      string *filename = *((string **)dub_checksdata(L, 1, "string"));
      ofBeginSaveScreenAsPDF(*filename);
      return 0;
    }
  } catch (std::exception &e) {
...
static int ofDrawBitmapString(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 4) {
      string *textString = *((string **)dub_checksdata(L, 1, "string"));
  ...
  try {
    ...
    if (top__ >= 5) {
      ...
      if (type__ == LUA_TNUMBER) {
        ...
        ofDrawBitmapStringHighlight(*text, *position, *background, *foreground);
        return 0;
      }
    } else if (top__ >= 3) {
      int type__ = lua_type(L, 2);
  ...
  try {
    ...
    if ( (ptr1__ = dub_issdata(L, 1, "ofTexture", type__)) ) {
      ...
      if ( (ptr2__ = dub_issdata(L, 2, "ofBuffer", type__)) ) {
        ofTexture *tex = *((ofTexture **)dub_checksdata(L, 1, "ofTexture"));
        ...
        lua_pushboolean(L, ofLoadImage(*tex, *path));
        return 1;
      }
    } else {
      int type__ = lua_type(L, 2);
      ...
      if ( (ptr2__ = dub_issdata(L, 2, "ofBuffer", type__)) ) {
        ...
        ofPixels *pix = *((ofPixels **)dub_checksdata(L, 1, "ofPixels"));
        string *path = *((string **)dub_checksdata(L, 2, "string"));
        lua_pushboolean(L, ofLoadImage(*pix, *path));
        return 1;
      }
    }
  } catch (std::exception &e) {
  ...
  try {
    ...
    if (top__ >= 4) {
      ...
      if ( (ptr2__ = dub_issdata(L, 2, "ofBuffer", type__)) ) {
        ...
        ofSaveImage(*pix, *path, qualityLevel);
        return 0;
      }
    } else {
      int type__ = lua_type(L, 2);
...
static int ofGetLogLevelName(lua_State *L) {
  try {
    ...
    dub_pushudata(L, new string(ofGetLogLevelName(level)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int _slang_library_noise1(lua_State *L) {
  try {
    ...
    lua_pushfstring(L, "_slang_library_noise1: %s", e.what());
  } catch (...) {
    lua_pushfstring(L, "_slang_library_noise1: Unknown exception");
  }
  return lua_error(L);
}
...
static int _slang_library_noise2(lua_State *L) {
  try {
    ...
    lua_pushfstring(L, "_slang_library_noise2: %s", e.what());
  } catch (...) {
    lua_pushfstring(L, "_slang_library_noise2: Unknown exception");
  }
  return lua_error(L);
}
...
static int _slang_library_noise3(lua_State *L) {
  try {
    ...
    lua_pushfstring(L, "_slang_library_noise3: %s", e.what());
  } catch (...) {
    lua_pushfstring(L, "_slang_library_noise3: Unknown exception");
  }
  return lua_error(L);
}
...
static int _slang_library_noise4(lua_State *L) {
  try {
    ...
    lua_pushfstring(L, "_slang_library_noise4: %s", e.what());
  } catch (...) {
    lua_pushfstring(L, "_slang_library_noise4: Unknown exception");
  }
  return lua_error(L);
}
...
static int ofSoundGetSpectrum(lua_State *L) {
  try {
    ...
    float *retval__ = ofSoundGetSpectrum(nBands);
    if (!retval__) return 0;
    dub_pushudata(L, retval__, "float", false);
    return 1;
  } catch (std::exception &e) {
...
static int ofSystemAlertDialog(lua_State *L) {
  try {
    string *errorMessage = *((string **)dub_checksdata(L, 1, "string"));
...
static int ofSystemLoadDialog(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
      string *windowTitle = *((string **)dub_checksdata(L, 1, "string"));
      bool bFolderSelection = dub_checkboolean(L, 2);
      string *defaultPath = *((string **)dub_checksdata(L, 3, "string"));
      dub_pushudata(L, new ofFileDialogResult(ofSystemLoadDialog(*windowTitle, bFolderSelection, *defaultPath)), "ofFileDialogResult", true);
      return 1;
    } else if (top__ >= 2) {
      string *windowTitle = *((string **)dub_checksdata(L, 1, "string"));
      bool bFolderSelection = dub_checkboolean(L, 2);
      dub_pushudata(L, new ofFileDialogResult(ofSystemLoadDialog(*windowTitle, bFolderSelection)), "ofFileDialogResult", true);
      return 1;
    } else if (top__ >= 1) {
      string *windowTitle = *((string **)dub_checksdata(L, 1, "string"));
      dub_pushudata(L, new ofFileDialogResult(ofSystemLoadDialog(*windowTitle)), "ofFileDialogResult", true);
      return 1;
    } else {
...
static int ofSystemSaveDialog(lua_State *L) {
  try {
    string *defaultName = *((string **)dub_checksdata(L, 1, "string"));
    string *messageName = *((string **)dub_checksdata(L, 2, "string"));
    dub_pushudata(L, new ofFileDialogResult(ofSystemSaveDialog(*defaultName, *messageName)), "ofFileDialogResult", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofSystemTextBoxDialog(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
      string *question = *((string **)dub_checksdata(L, 1, "string"));
      string *text = *((string **)dub_checksdata(L, 2, "string"));
      dub_pushudata(L, new string(ofSystemTextBoxDialog(*question, *text)), "string", true);
      return 1;
    } else {
      string *question = *((string **)dub_checksdata(L, 1, "string"));
      dub_pushudata(L, new string(ofSystemTextBoxDialog(*question)), "string", true);
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofSetTextureWrap(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
      GLfloat *wrapS = *((GLfloat **)dub_checksdata(L, 1, "GLfloat"));
      GLfloat *wrapT = *((GLfloat **)dub_checksdata(L, 2, "GLfloat"));
...
static int ofSetMinMagFilters(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
      GLfloat *minFilter = *((GLfloat **)dub_checksdata(L, 1, "GLfloat"));
      GLfloat *maxFilter = *((GLfloat **)dub_checksdata(L, 2, "GLfloat"));
...
static int ofLoadURL(lua_State *L) {
  try {
    ...
    dub_pushudata(L, new ofHttpResponse(ofLoadURL(*url)), "ofHttpResponse", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofLoadURLAsync(lua_State *L) {
  try {
    ...
    if (top__ >= 2) {
      ...
      lua_pushnumber(L, ofLoadURLAsync(*url, *name));
      return 1;
    } else {
      string *url = *((string **)dub_checksdata(L, 1, "string"));
      lua_pushnumber(L, ofLoadURLAsync(*url));
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofSaveURLTo(lua_State *L) {
  try {
    string *url = *((string **)dub_checksdata(L, 1, "string"));
    string *path = *((string **)dub_checksdata(L, 2, "string"));
    dub_pushudata(L, new ofHttpResponse(ofSaveURLTo(*url, *path)), "ofHttpResponse", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofSaveURLAsync(lua_State *L) {
  try {
    string *url = *((string **)dub_checksdata(L, 1, "string"));
    string *path = *((string **)dub_checksdata(L, 2, "string"));
    lua_pushnumber(L, ofSaveURLAsync(*url, *path));
    return 1;
  } catch (std::exception &e) {
...
static int ofGetElapsedTimeMillis(lua_State *L) {
  try {
    dub_pushudata(L, new unsigned long long(ofGetElapsedTimeMillis()), "unsigned long long", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetElapsedTimeMicros(lua_State *L) {
  try {
    dub_pushudata(L, new unsigned long long(ofGetElapsedTimeMicros()), "unsigned long long", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetSystemTime(lua_State *L) {
  try {
    dub_pushudata(L, new unsigned long long(ofGetSystemTime()), "unsigned long long", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetSystemTimeMicros(lua_State *L) {
  try {
    dub_pushudata(L, new unsigned long long(ofGetSystemTimeMicros()), "unsigned long long", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetTimestampString(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 1) {
      string *timestampFormat = *((string **)dub_checksdata(L, 1, "string"));
      dub_pushudata(L, new string(ofGetTimestampString(*timestampFormat)), "string", true);
      return 1;
    } else {
      dub_pushudata(L, new string(ofGetTimestampString()), "string", true);
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofToDataPath(lua_State *L) {
  try {
    ...
    if (top__ >= 2) {
      ...
      dub_pushudata(L, new string(ofToDataPath(*path, absolute)), "string", true);
      return 1;
    } else {
      string *path = *((string **)dub_checksdata(L, 1, "string"));
      dub_pushudata(L, new string(ofToDataPath(*path)), "string", true);
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofSetDataPathRoot(lua_State *L) {
  try {
    string *root = *((string **)dub_checksdata(L, 1, "string"));
...
static int ofToHex(lua_State *L) {
  try {
    ...
    dub_pushudata(L, new string(ofToHex(value)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofHexToInt(lua_State *L) {
  try {
    string *intHexString = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofHexToInt(*intHexString));
    return 1;
  } catch (std::exception &e) {
...
static int ofHexToChar(lua_State *L) {
  try {
    string *charHexString = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofHexToChar(*charHexString));
    return 1;
  } catch (std::exception &e) {
...
static int ofHexToFloat(lua_State *L) {
  try {
    string *floatHexString = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofHexToFloat(*floatHexString));
    return 1;
  } catch (std::exception &e) {
...
static int ofHexToString(lua_State *L) {
  try {
    string *stringHexString = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofHexToString(*stringHexString)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofToInt(lua_State *L) {
  try {
    string *intString = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofToInt(*intString));
    return 1;
  } catch (std::exception &e) {
...
static int ofToChar(lua_State *L) {
  try {
    string *charString = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofToChar(*charString));
    return 1;
  } catch (std::exception &e) {
...
static int ofToFloat(lua_State *L) {
  try {
    string *floatString = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofToFloat(*floatString));
    return 1;
  } catch (std::exception &e) {
...
static int ofToDouble(lua_State *L) {
  try {
    string *doubleString = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofToDouble(*doubleString));
    return 1;
  } catch (std::exception &e) {
...
static int ofToBool(lua_State *L) {
  try {
    string *boolString = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushboolean(L, ofToBool(*boolString));
    return 1;
  } catch (std::exception &e) {
...
static int ofToBinary(lua_State *L) {
  try {
    const char *value = dub_checkstring(L, 1);
    dub_pushudata(L, new string(ofToBinary(value)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofBinaryToInt(lua_State *L) {
  try {
    string *value = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofBinaryToInt(*value));
    return 1;
  } catch (std::exception &e) {
...
static int ofBinaryToChar(lua_State *L) {
  try {
    string *value = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofBinaryToChar(*value));
    return 1;
  } catch (std::exception &e) {
...
static int ofBinaryToFloat(lua_State *L) {
  try {
    string *value = *((string **)dub_checksdata(L, 1, "string"));
    lua_pushnumber(L, ofBinaryToFloat(*value));
    return 1;
  } catch (std::exception &e) {
...
static int ofBinaryToString(lua_State *L) {
  try {
    string *value = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofBinaryToString(*value)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofGetVersionInfo(lua_State *L) {
  try {
    dub_pushudata(L, new string(ofGetVersionInfo()), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofSplitString(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 4) {
      string *source = *((string **)dub_checksdata(L, 1, "string"));
      string *delimiter = *((string **)dub_checksdata(L, 2, "string"));
      bool ignoreEmpty = dub_checkboolean(L, 3);
      bool trim = dub_checkboolean(L, 4);
      dub_pushudata(L, new vector< string >(ofSplitString(*source, *delimiter, ignoreEmpty, trim)), "vector< string >", true);
      return 1;
    } else if (top__ >= 3) {
      string *source = *((string **)dub_checksdata(L, 1, "string"));
      string *delimiter = *((string **)dub_checksdata(L, 2, "string"));
      bool ignoreEmpty = dub_checkboolean(L, 3);
      dub_pushudata(L, new vector< string >(ofSplitString(*source, *delimiter, ignoreEmpty)), "vector< string >", true);
      return 1;
    } else {
      string *source = *((string **)dub_checksdata(L, 1, "string"));
      string *delimiter = *((string **)dub_checksdata(L, 2, "string"));
      dub_pushudata(L, new vector< string >(ofSplitString(*source, *delimiter)), "vector< string >", true);
      return 1;
    }
  } catch (std::exception &e) {
...
static int ofJoinString(lua_State *L) {
  try {
    ...
    string *delimiter = *((string **)dub_checksdata(L, 2, "string"));
    dub_pushudata(L, new string(ofJoinString(*stringElements, *delimiter)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofIsStringInString(lua_State *L) {
  try {
    string *haystack = *((string **)dub_checksdata(L, 1, "string"));
    string *needle = *((string **)dub_checksdata(L, 2, "string"));
    lua_pushboolean(L, ofIsStringInString(*haystack, *needle));
    return 1;
  } catch (std::exception &e) {
...
static int ofToLower(lua_State *L) {
  try {
    string *src = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofToLower(*src)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofToUpper(lua_State *L) {
  try {
    string *src = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofToUpper(*src)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofVAArgsToString(lua_State *L) {
  try {
    ...
    va_list *args = *((va_list **)dub_checksdata(L, 2, "va_list"));
    dub_pushudata(L, new string(ofVAArgsToString(format, *args)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
static int ofSystem(lua_State *L) {
  try {
    string *command = *((string **)dub_checksdata(L, 1, "string"));
    dub_pushudata(L, new string(ofSystem(*command)), "string", true);
    return 1;
  } catch (std::exception &e) {
...
extern "C" int luaopen_of(lua_State *L) {
  luaopen_ofAppBaseWindow(L);
  luaopen_ofBaseApp(L);
  luaopen_ofBaseDraws(L);
  luaopen_ofBaseUpdates(L);
  luaopen_ofBaseHasTexture(L);
  luaopen_ofAbstractHasPixels(L);
  luaopen_ofAbstractImage(L);
  luaopen_ofBaseSoundInput(L);
  luaopen_ofBaseSoundOutput(L);
  luaopen_ofBaseVideo(L);
  luaopen_ofBaseVideoDraws(L);
  luaopen_ofBaseVideoGrabber(L);
  luaopen_ofBaseVideoPlayer(L);
  luaopen_ofBaseRenderer(L);
  ...
  luaopen_ofImage(L);
  luaopen_ofFloatImage(L);
  luaopen_ofShortImage(L);

  // Create the table which will contain all the constants
  lua_getfield(L, LUA_GLOBALSINDEX, "of");
  if (lua_isnil(L, -1)) {
    // no global table called of
    lua_pop(L, 1);
    lua_newtable(L);
    // <lib>
    lua_pushvalue(L, -1);
